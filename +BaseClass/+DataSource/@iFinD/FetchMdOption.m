...
switch inv
    ...
    case EnumType.Interval.day                 
        [is_err, md] = obj.FetchDailyMd(symb, exc, ts_s, ts_e, ...
            'ths_open_price_option;ths_high_price_option;ths_low_option;ths_close_price_option;ths_amt_option;ths_vol_option;ths_open_interest_option;ths_surplus_duration_calendar_option;ths_surplus_duration_td_option', ...            
            ';;;;;;;0;0', ...
