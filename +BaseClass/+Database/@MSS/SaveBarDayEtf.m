...
% 准备sql
sql = " IF EXISTS (SELECT * FROM [%s] WHERE [DATETIME] = '%s') UPDATE [%s] SET [NAV] = %f, [NAV_ADJ] = %f, [OPEN] = %f, [HIGH] = %f, [LOW] = %f, [LAST] = %f, [TURNOVER] = %f, [VOLUME] = %f WHERE [DATETIME] = '%s' ELSE INSERT [%s]([DATETIME], [NAV], [NAV_ADJ], [OPEN], [HIGH], [LOW], [LAST], [TURNOVER], [VOLUME]) VALUES ('%s', %f, %f, %f, %f, %f, %f, %f, %f)";
